...
\begin{task}{0.3.4}
Since $(19)_{10}=(10011)_2$ and $(2^{-k})_{10}=(0.00\ldots001)_2$ where the number of zeros is equal to $k$ the sum will be $10011.\underbrace{00\ldots00}_{k - 1 \text{ zeros}}1$. In the IEEE format the right-most 1 will be at the $(k+4)$th bit. For the number to be represented exactly in double precision $k+4 \le 52 \lra k \le 48$. The largest possible value of $k$ therefore is 48.
\end{task}