...
\begin{task}{0.3.3}
Since $(5)_{10}=(101)_2$ and $(2^{-k})_{10}=(0.00\ldots001)_2$ where the number of zeros is equal to $k$ the sum will be $101.\underbrace{00\ldots00}_{k - 1 \text{ zeros}}1$. In the IEEE format the right-most 1 will be at the $(k-1+3)$th bit. For the number to be represented exactly in double precision $k-1+3 \le 52 \lra k \le 50$. Since $k$ can't be negative, $0 \le k \le 50$.
\end{task}